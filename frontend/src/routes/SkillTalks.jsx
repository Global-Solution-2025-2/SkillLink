...
export default function SkillTalks() {
  ...
  // Verificar se há contato selecionado do Connect Hub
  useEffect(() => {
    const contatoSelecionado = localStorage.getItem('contatoSelecionado');
    if (contatoSelecionado) {
      abrirChat(contatoSelecionado);
      localStorage.removeItem('contatoSelecionado');
      localStorage.removeItem('contatoNome');
    }
  }, []);
