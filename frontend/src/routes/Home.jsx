...
import { FaRobot, FaLaptopCode, FaGlobe, FaBrain, FaScroll, FaCalendarAlt, FaGraduationCap, FaSun, FaMoon } from 'react-icons/fa';
...
const Home = () => {
  ...
  // Corrigido para garantir contraste: Escuro no Light / Ciano no Dark
  ...
  return (
    <div className="min-h-screen bg-light dark:bg-dark text-light dark:text-dark transition-colors duration-500">
      ...
      {/* 🚀 Banner e Navegação de Destaque */}
      
        
        <div className="max-w-3xl mx-auto px-6 pt-5 pb-">
            <h1 className="text-5xl font-extrabold mb-4">Desbloqueie seu Futuro Digital.</h1>
            <p className="text-xl opacity-90 mb-8 ml-auto max-w-2xl mx-auto">
              Seu ponto de partida para as **carreiras mais inovadoras** em IA, VR/AR, Sustentabilidade e Neurotecnologia.
            </p>
            <a href="#" className="inline-flex items-center bg-cyan-400 text-gray-900 font-bold py-3 px-8 rounded-full shadow-lg hover:bg-cyan-300 transform hover:scale-105 transition duration-300 ease-in-out">
                Comece a Explorar <BsArrowRight className="ml-2 text-xl" />
            </a>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        ...
        <section className="mb-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {profissoes.map((profissao, index) => (
              ...
              >
                ...
                <p className="text-sm font-semibold mb-3 text-gray-600 dark:text-gray-400">Habilidades Essenciais:</p>
          ...
          {/* BOTÃO CORRIGIDO E ESTILIZADO (OPÇÃO 1) */}
        ...
        <section className={`mb-24 bg-gray-50 dark:bg-gray-900 p-10 rounded-3xl shadow-lg dark:shadow-inner dark:shadow-blue-900/30`}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {cursos.map((curso, index) => (
              <div
                key={index}
                className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-xl dark:shadow-none border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-600 transform hover:scale-[1.02] transition duration-300"
              >
